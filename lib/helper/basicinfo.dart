...
class BasicInfo {
  ...
  static double minSizeWidth = 350;
  static double minSizeHeight = 600;
  static double maxSizeWidth = 800;

  static String getURL() {
    String serverIP = "http://5.182.44.212:81"; // 81:Debug  ,  5000:Release
    // serverIP = "http://185.255.89.224";
    serverIP = "http://likerdshop.ir:81";
    return getAppData(isDebug)['serverAddress'];
  }

  static String getFontName({bool LTR = true}) {
    return LTR ? "Calibri" : "Sans";
  }
  ...
  static Color getColors(String name) {
    ...
    return myColors[name] ?? getMainColor();
  }
  ...
  static Map getAppData(bool isDebuging) {
    Map release_data = {'serverAddress': 'http://likerdshop.ir:5000/exchange'};
    Map debug_data = {'serverAddress': 'http://likerdshop.ir:7448/exchange'};
    if (isDebuging) {
      return debug_data;
    } else {
      return release_data;
